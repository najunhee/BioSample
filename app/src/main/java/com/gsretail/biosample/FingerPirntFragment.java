...
public class FingerPirntFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.button_fingerprint).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(FingerPirntFragment.this)
                        .navigate(R.id.action_FingerPrintFragment_to_HomeFragment);
            }
        });
